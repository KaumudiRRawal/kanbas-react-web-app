    ...
    <div id="wd-assignments-editor" className="container mt-4">
      <form>
        ...
        <div className="mb-3">
          ...
          <textarea id="wd-description" className="form-control" rows={5} defaultValue="The assignment is available online. Submit a link to the landing page of your Web application running on Netlify."></textarea>
        </div>
          ...
          <div className="col-md-9 mb-3 border p-3 rounded">
            ...
            <div>
              <div className="col-md-13">
                ...
                <input type="datetime-local" id="wd-due" className="form-control mb-3" />
              </div>
              <div className="d-flex mb-3">
                ...
                <div className="col-md-6">
                  ...
                  <input type="datetime-local" id="wd-until" className="form-control" />
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="d-flex justify-content-end mb-3">
          <Link to={`/Kanbas/Courses/${assignment.course}/Assignments`} className="btn btn-secondary me-2">Cancel</Link>
